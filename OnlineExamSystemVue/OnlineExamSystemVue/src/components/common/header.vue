...
<template>
    <header id="topbar">
        <el-dialog :append-to-body="true" style="z-index: 2028px" title="修改密码" :visible.sync="dialogVisible"
            width="30%">
        ...
        <el-row>
            <el-col :span="6" class="topbar-left">
                <span style="font-size: 32px; font-weight: 600; color: #000;padding: 0 10px">在线考试系统</span>
                ...
                <div class="user">
                    ...
                    <transition name="fade">
                        <div class="out" ref="out" v-show="login_flag">
                            <ul>
                                <li v-if="role == 0">
                                    <a @click="dialogVisible = true" href="javascript:;">修改密码</a>
                                </li>

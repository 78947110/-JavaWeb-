...
<template>
    <div id="student">
        <el-row class="padding-50">
            <el-col :span="24">
                <ul class="list" style="width:100%;display: flex;justify-content: space-around">
                    <li class="logo">
                        <img src="@/assets/img/icon.png" style="
                            width: 35px;
                            height: 35px;
                            margin: 13px 0 0 0px;
                    ...
                    <li>
                        <router-link to="/scoreTable">查看成绩</router-link>
                    </li>
                    ...
                    <li class="right" @mouseenter="flag = !flag" @mouseleave="flag = !flag">
                        <el-row>
                            <el-col :span="12">
                                <el-avatar shape="circle" :size="50" :src="require('@/assets/img/avatar.jpg')"
